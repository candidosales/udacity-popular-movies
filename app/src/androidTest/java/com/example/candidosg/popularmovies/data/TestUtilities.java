...
import com.example.candidosg.popularmovies.utils.PollingCheck;

import java.util.Map;
import java.util.Set;

/**
 * Created by candidosg on 12/08/16.
 */
...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createMovieValues() {
        ...
        movieValues.put(MovieContract.MovieEntry.COLUMN_POSTER_PATH, "img.jpg");
        movieValues.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, "2016-01-01");
        movieValues.put(MovieContract.MovieEntry.COLUMN_VOTE_AVERAGE, "8");
